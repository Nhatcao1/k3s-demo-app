...
| Colab rejects or cannot load the FIDES wheel | The old wheel was built on Ubuntu 24.04 and required glibc 2.39. | Build release 0.3.5+ from the Ubuntu 22.04 CUDA stage and require the `manylinux_2_35_x86_64` wheel check in CI. |
